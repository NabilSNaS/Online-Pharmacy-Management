<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="OnlinePharmacyManagementSystem.View.Seller.Login" %>
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-5 mb-3">
            ...
            <div class="col-md-4 bg-white">
               ...
               <div class="justify-content-center"><img src="../../Assets/images/Login1.jpg"/></div >
                <form runat="server">
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="password" class="form-control" id="PasswordTb" runat="server" autocomplete="off"/>
                    ...
                    <div class="d-grid mb-3">
                       ...
                       <a href="../Admin/Login.aspx" class="text-success"> <label class="h4 text-center">Admin</label></a>
